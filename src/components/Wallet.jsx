...
export default function Wallet() {
  ...
  const handleFetchCityData = () => {
    if (user.signer) {
      fetchCityData(user.address, user.signer);
    }
  };
    ...
    <div>
      ...
      {user.isConnected ? (
        <div>
          ...
          <button onClick={disconnectWalletHandler} className="text-red-500">
            Disconect Wallet
          </button>{" "}
        ...
        <button
          ...
          type="button"
          className="text-white bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center  me-2 mb-2 border-2 border-white hover:bg-yellow-400 hover:text-black hover:border-blue-800"
        >
          <svg
            aria-hidden="true"
